...
public class ReportService{
    ...
    public void generateStrategyReport(String strategyName, List<Map<String, Object>> dataList) throws IOException{
        ...
        for(Map<String, Object> data : dataList){
            Row row = sheet.createRow(rowNum); // declare a row object reference
        ...
        FileOutputStream out = new FileOutputStream("D:\\DailyStockReport\\" + strategyName + "_" + DateUtils.todayDate + ".xlsx");
        workbook.write(out);
        out.close();
        workbook.close();
    }
